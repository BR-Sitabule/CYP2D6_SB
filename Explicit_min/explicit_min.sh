...
/
" >explicit_min1.in
sander -O -i explicit_min1.in -o explicit_min1.out -p CYP2D6_min_topology.prmtop -c CYP2D6_min_topology.rst7 -ref CYP2D6_min_topology.rst7
...
/
" >explicit_min2.in
sander -O -i explicit_min2.in -o explicit_min2.out -p CYP2D6_min_topology.prmtop -c relax_CYP2D6_min_explicit.rst
